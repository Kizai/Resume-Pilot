...
API_URL, API_KEY, TIMEOUT_SECONDS, MAX_RETRY, LLM_MODEL = \
    get_conf('API_URL', 'API_KEY', 'TIMEOUT_SECONDS', 'MAX_RETRY', 'LLM_MODEL')
            ...
            if chunk:
                try:
                    ...
                    if "reduce the length" in error_msg:
                        ...
                        from src.toolbox import regular_txt_to_markdown
