import gradio as gr
from config import CODE_HIGHLIGHT
...
def adjust_theme():
    try:
        color_er = gr.themes.utils.colors.green

        theme = gr.themes.Default(
            primary_hue=gr.themes.utils.colors.teal,
        ...
        print('The gradio version is older, and the font and color cannot be customized')
        return None
